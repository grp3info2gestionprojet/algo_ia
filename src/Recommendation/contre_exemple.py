...
class GenerateurContreExemples:
    ...
    def formater_message_contre_exemple(self, contre_exemple):
        ...
        # Trouver les différences pour proposer l'action à faire
        # On suppose que le format est (Rouge, Bleu, Jaune, Vert) qui correspond 
        # aux couleurs B, J, R, V de votre classe
